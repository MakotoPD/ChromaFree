...
use chromafree_ipc::{ObjectNames, OutputMode, PixelFormat, ProducerChannel, ReaderChannel};

fn unique_names(test: &str) -> ObjectNames {
    ObjectNames::with_prefix(&format!(r"Local\chromafree-test-{}-{test}-", std::process::id()))
}

...
use chromafree_ipc::layout::CHROMAFREE_HEADER_SIZE;
use chromafree_ipc::{IpcError, PixelFormat, SharedRegion};
...
fn memory(capacity: usize) -> Arc<Memory> {
    let len = (CHROMAFREE_HEADER_SIZE as usize + capacity).div_ceil(8);
